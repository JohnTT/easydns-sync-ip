...
// checks if the ErrorModel420Error type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorModel420Error{}
...
type _ErrorModel420Error ErrorModel420Error
...
func (o *ErrorModel420Error) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorModel420Error := _ErrorModel420Error{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorModel420Error)

	if err != nil {
		return err
	}

	*o = ErrorModel420Error(varErrorModel420Error)

	return err
}

type NullableErrorModel420Error struct {
	value *ErrorModel420Error
	isSet bool
}

func (v NullableErrorModel420Error) Get() *ErrorModel420Error {
	return v.value
}

func (v *NullableErrorModel420Error) Set(val *ErrorModel420Error) {
	v.value = val
	v.isSet = true
}
...
func NewNullableErrorModel420Error(val *ErrorModel420Error) *NullableErrorModel420Error {
	return &NullableErrorModel420Error{value: val, isSet: true}
}
