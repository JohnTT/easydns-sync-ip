...
// checks if the ContactDataTech type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactDataTech{}
...
type _ContactDataTech ContactDataTech
...
func (o *ContactDataTech) UnmarshalJSON(data []byte) (err error) {
	...
	varContactDataTech := _ContactDataTech{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varContactDataTech)

	if err != nil {
		return err
	}

	*o = ContactDataTech(varContactDataTech)

	return err
}

type NullableContactDataTech struct {
	value *ContactDataTech
	isSet bool
}

func (v NullableContactDataTech) Get() *ContactDataTech {
	return v.value
}

func (v *NullableContactDataTech) Set(val *ContactDataTech) {
	v.value = val
	v.isSet = true
}
...
func NewNullableContactDataTech(val *ContactDataTech) *NullableContactDataTech {
	return &NullableContactDataTech{value: val, isSet: true}
}
