...
// checks if the ContactDataOwner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactDataOwner{}
...
type _ContactDataOwner ContactDataOwner
...
// GetCprOk returns a tuple with the Cpr field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
func (o *ContactDataOwner) UnmarshalJSON(data []byte) (err error) {
	...
	varContactDataOwner := _ContactDataOwner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varContactDataOwner)

	if err != nil {
		return err
	}

	*o = ContactDataOwner(varContactDataOwner)

	return err
}

type NullableContactDataOwner struct {
	value *ContactDataOwner
	isSet bool
}

func (v NullableContactDataOwner) Get() *ContactDataOwner {
	return v.value
}

func (v *NullableContactDataOwner) Set(val *ContactDataOwner) {
	v.value = val
	v.isSet = true
}
...
func NewNullableContactDataOwner(val *ContactDataOwner) *NullableContactDataOwner {
	return &NullableContactDataOwner{value: val, isSet: true}
}
