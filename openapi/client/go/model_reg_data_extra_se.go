...
// checks if the RegDataExtraSE type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegDataExtraSE{}
...
type _RegDataExtraSE RegDataExtraSE
...
func (o *RegDataExtraSE) UnmarshalJSON(data []byte) (err error) {
	...
	varRegDataExtraSE := _RegDataExtraSE{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRegDataExtraSE)

	if err != nil {
		return err
	}

	*o = RegDataExtraSE(varRegDataExtraSE)

	return err
}

type NullableRegDataExtraSE struct {
	value *RegDataExtraSE
	isSet bool
}

func (v NullableRegDataExtraSE) Get() *RegDataExtraSE {
	return v.value
}

func (v *NullableRegDataExtraSE) Set(val *RegDataExtraSE) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRegDataExtraSE(val *RegDataExtraSE) *NullableRegDataExtraSE {
	return &NullableRegDataExtraSE{value: val, isSet: true}
}
